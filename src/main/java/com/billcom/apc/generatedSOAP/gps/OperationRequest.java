...
public abstract class OperationRequest  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://gps.webservices", "OperationRequest"));
    }
