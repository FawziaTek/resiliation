...
/**
 * <p>Classe Java pour GetCalculatedFaccTotaleResponse complex type.
 * 
...
@XmlType(name = "GetCalculatedFaccTotaleResponse", namespace = "http://alu.services.ws.lhs.com", propOrder = {
    "bean",
    "montantTotal"
})
public class GetCalculatedFaccTotaleResponse
