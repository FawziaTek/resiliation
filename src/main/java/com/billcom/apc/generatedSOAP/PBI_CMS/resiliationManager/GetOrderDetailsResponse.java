...
/**
 * <p>Classe Java pour getOrderDetailsResponse complex type.
 * 
 ...
 *       &lt;sequence&gt;
 *         &lt;element name="beans" type="{http://manager.ws.resiliation.billcom.com/}orderDetailsBean" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class GetOrderDetailsResponse {
    ...
    protected List<OrderDetailsBean> beans;
     ...
     * {@link OrderDetailsBean }
     * 
     * 
     */
    public List<OrderDetailsBean> getBeans() {
        if (beans == null) {
            beans = new ArrayList<OrderDetailsBean>();
        }
        return this.beans;
    }
