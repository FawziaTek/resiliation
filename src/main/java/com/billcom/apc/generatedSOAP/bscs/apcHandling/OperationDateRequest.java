...
public class OperationDateRequest  implements java.io.Serializable {
    private com.billcom.apc.generatedSOAP.bscs.apcHandling.Service[] activateService;
    ...
    public OperationDateRequest(
           com.billcom.apc.generatedSOAP.bscs.apcHandling.Service[] activateService,
           java.lang.Long coId,
     ...
     */
    public com.billcom.apc.generatedSOAP.bscs.apcHandling.Service[] getActivateService() {
        return activateService;
    }
     ...
     */
    public void setActivateService(com.billcom.apc.generatedSOAP.bscs.apcHandling.Service[] activateService) {
        this.activateService = activateService;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getActivateService() != null) {
            for (int i=0;
                 ...
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getActivateService(), i);
                if (obj != null &&
        ...
        if (getDesctivateService() != null) {
            for (int i=0;
                 ...
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getDesctivateService(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
