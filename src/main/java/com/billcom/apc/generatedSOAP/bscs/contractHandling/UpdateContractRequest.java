...
public class UpdateContractRequest  implements java.io.Serializable {
    private com.billcom.apc.generatedSOAP.bscs.contractHandling.Contract contract;

    private com.billcom.apc.generatedSOAP.bscs.contractHandling.SessionChange sessionChange;

    public UpdateContractRequest() {
    }

    public UpdateContractRequest(
           com.billcom.apc.generatedSOAP.bscs.contractHandling.Contract contract,
           com.billcom.apc.generatedSOAP.bscs.contractHandling.SessionChange sessionChange) {
     ...
     * @return contract
     */
    public com.billcom.apc.generatedSOAP.bscs.contractHandling.Contract getContract() {
        return contract;
    }
     ...
     * @param contract
     */
    public void setContract(com.billcom.apc.generatedSOAP.bscs.contractHandling.Contract contract) {
        this.contract = contract;
    }
     ...
     */
    public com.billcom.apc.generatedSOAP.bscs.contractHandling.SessionChange getSessionChange() {
        return sessionChange;
    }
     ...
     * @param sessionChange
     */
    public void setSessionChange(com.billcom.apc.generatedSOAP.bscs.contractHandling.SessionChange sessionChange) {
        this.sessionChange = sessionChange;
    }
