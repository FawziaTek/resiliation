...
public class EligibilityTemplateResponse  extends com.billcom.apc.generatedSOAP.bscs.apcHandling.OperationResponse  implements java.io.Serializable {
    ...
    public synchronized int hashCode() {
        ...
        if (getTemplateId() != null) {
            for (int i=0;
                 ...
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getTemplateId(), i);
                if (obj != null &&
