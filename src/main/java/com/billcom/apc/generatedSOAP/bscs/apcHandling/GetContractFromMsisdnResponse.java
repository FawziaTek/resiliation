...
public class GetContractFromMsisdnResponse  extends com.billcom.apc.generatedSOAP.bscs.apcHandling.OperationResponse  implements java.io.Serializable {
    private com.billcom.apc.generatedSOAP.bscs.apcHandling.ContractBean[] contracts;
    ...
    public GetContractFromMsisdnResponse(
           ...
           com.billcom.apc.generatedSOAP.bscs.apcHandling.ContractBean[] contracts) {
        super(
            bscsErrorCode,
            comment,
            isSuccessful);
     ...
     * @return contracts
     */
    public com.billcom.apc.generatedSOAP.bscs.apcHandling.ContractBean[] getContracts() {
        return contracts;
    }
     ...
     * @param contracts
     */
    public void setContracts(com.billcom.apc.generatedSOAP.bscs.apcHandling.ContractBean[] contracts) {
        this.contracts = contracts;
    }
