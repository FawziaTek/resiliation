...
public class AddCugRequest  implements java.io.Serializable {
    ...
    private com.billcom.apc.generatedSOAP.bscs.apcHandling.CUGBean[] cugs;
    ...
    public AddCugRequest(
           java.lang.Long coId,
           com.billcom.apc.generatedSOAP.bscs.apcHandling.CUGBean[] cugs) {
           this.coId = coId;
           this.cugs = cugs;
    }
     ...
     * @return cugs
     */
    public com.billcom.apc.generatedSOAP.bscs.apcHandling.CUGBean[] getCugs() {
        return cugs;
    }
     ...
     * @param cugs
     */
    public void setCugs(com.billcom.apc.generatedSOAP.bscs.apcHandling.CUGBean[] cugs) {
        this.cugs = cugs;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getCugs() != null) {
            for (int i=0;
                 ...
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getCugs(), i);
                if (obj != null &&
