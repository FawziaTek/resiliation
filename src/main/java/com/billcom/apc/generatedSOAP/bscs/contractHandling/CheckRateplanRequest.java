...
public class CheckRateplanRequest  implements java.io.Serializable {
    ...
    private com.billcom.apc.generatedSOAP.bscs.contractHandling.Reference rateplan;
    ...
    public CheckRateplanRequest(
           ...
           com.billcom.apc.generatedSOAP.bscs.contractHandling.Reference rateplan) {
     ...
     * @return rateplan
     */
    public com.billcom.apc.generatedSOAP.bscs.contractHandling.Reference getRateplan() {
        return rateplan;
    }
     ...
     * @param rateplan
     */
    public void setRateplan(com.billcom.apc.generatedSOAP.bscs.contractHandling.Reference rateplan) {
        this.rateplan = rateplan;
    }
