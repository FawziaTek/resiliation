...
public class DesactivateServicesResponse  extends com.billcom.apc.generatedSOAP.bscs.apcHandling.OperationResponse  implements java.io.Serializable {
    ...
    public synchronized int hashCode() {
        ...
        if (getSnCodes() != null) {
            for (int i=0;
                 ...
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getSnCodes(), i);
                if (obj != null &&
