...
public class OperationType  implements java.io.Serializable {
    ...
    /**
     * Gets the id value for this OperationType.
     * 
     * @return id
     */
    ...
    /**
     * Sets the id value for this OperationType.
     * 
     * @param id
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://alu.services.ws.lhs.com", "OperationType"));
