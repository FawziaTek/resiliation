...
public class InfoConsoRequest  implements java.io.Serializable {
    private com.billcom.apc.generatedSOAP.bscs.contractHandling.ContractReference contractReference;

    public InfoConsoRequest() {
    }

    public InfoConsoRequest(
           com.billcom.apc.generatedSOAP.bscs.contractHandling.ContractReference contractReference) {
     ...
     */
    public com.billcom.apc.generatedSOAP.bscs.contractHandling.ContractReference getContractReference() {
        return contractReference;
    }
     ...
     */
    public void setContractReference(com.billcom.apc.generatedSOAP.bscs.contractHandling.ContractReference contractReference) {
        this.contractReference = contractReference;
    }
