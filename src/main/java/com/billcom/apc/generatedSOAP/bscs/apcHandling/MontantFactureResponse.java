...
public class MontantFactureResponse  extends com.billcom.apc.generatedSOAP.bscs.apcHandling.OperationResponse  implements java.io.Serializable {
    private com.billcom.apc.generatedSOAP.bscs.apcHandling.MoneyBean montant;
    ...
    public MontantFactureResponse(
           ...
           com.billcom.apc.generatedSOAP.bscs.apcHandling.MoneyBean montant) {
        super(
            bscsErrorCode,
            comment,
            isSuccessful);
     ...
     * @return montant
     */
    public com.billcom.apc.generatedSOAP.bscs.apcHandling.MoneyBean getMontant() {
        return montant;
    }
     ...
     * @param montant
     */
    public void setMontant(com.billcom.apc.generatedSOAP.bscs.apcHandling.MoneyBean montant) {
        this.montant = montant;
    }
