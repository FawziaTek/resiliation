...
public class In0  extends com.billcom.apc.generatedSOAP.bscs.contractServicesRead.BaseSOIBean  implements java.io.Serializable {
    private com.billcom.apc.generatedSOAP.bscs.contractServicesRead.ContractServicesReadBeanIn input;

    private com.billcom.apc.generatedSOAP.bscs.contractServicesRead.SessionChangeBeanIn sessionChange;

    public In0() {
    }

    public In0(
           com.billcom.apc.generatedSOAP.bscs.contractServicesRead.ContractServicesReadBeanIn input,
           com.billcom.apc.generatedSOAP.bscs.contractServicesRead.SessionChangeBeanIn sessionChange) {
        this.input = input;
     ...
     * @return input
     */
    public com.billcom.apc.generatedSOAP.bscs.contractServicesRead.ContractServicesReadBeanIn getInput() {
        return input;
    }
     ...
     * @param input
     */
    public void setInput(com.billcom.apc.generatedSOAP.bscs.contractServicesRead.ContractServicesReadBeanIn input) {
        this.input = input;
    }
     ...
     */
    public com.billcom.apc.generatedSOAP.bscs.contractServicesRead.SessionChangeBeanIn getSessionChange() {
        return sessionChange;
    }
     ...
     * @param sessionChange
     */
    public void setSessionChange(com.billcom.apc.generatedSOAP.bscs.contractServicesRead.SessionChangeBeanIn sessionChange) {
        this.sessionChange = sessionChange;
    }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.lhsgroup.com/ws_v2", "ContractServicesReadBeanIn"));
